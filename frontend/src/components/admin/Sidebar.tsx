  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'coupon-settings',
          label: t('navigation.couponSettings'),
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'workflow-test',
          label: t('navigation.workflowTest', 'Workflow Test'),
        ...
        {
          id: 'blocked-users',
          label: t('navigation.blockedUsers', 'Engelli Kullanıcılar'),
        ...
        {
          id: 'suspicious-users',
          label: t('navigation.suspiciousUsers', 'Şüpheli Kullanıcılar'),
