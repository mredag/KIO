...
- [x] 1.3 Update DatabaseService with coupon table initialization
...
- [x] 2.1 Implement PhoneNormalizer utility
...
- [x] 2.3 Implement TokenGenerator utility
...
- [x] 2.5 Implement PII masking utilities
...
- [x] 2.7 Implement EventLogService
...
- [x] 3. CouponService Implementation





- [x] 3.1 Implement issueToken() method
...
- [x] 3.3 Implement consumeToken() method
...
- [x] 3.5 Implement getWallet() method
...
- [x] 3.7 Implement claimRedemption() method
...
- [x] 3.9 Implement completeRedemption() method
...
- [x] 3.11 Implement rejectRedemption() method
...
- [x] 3.13 Implement optOut() method
...
- [x] 4. Rate Limiting Implementation



- [x] 4.1 Implement RateLimitService
...
- [x] 4.3 Implement couponRateLimit middleware
...
- [x] 5.1 Implement apiKeyAuth middleware
...
- [x] 5.3 Verify admin session authentication middleware exists
...
- [x] 6.1 Implement POST /api/admin/coupons/issue
...
- [x] 6.2 Implement GET /api/admin/coupons/wallet/:phone
...
- [x] 6.3 Implement GET /api/admin/coupons/redemptions
...
- [x] 6.5 Implement POST /api/admin/coupons/redemptions/:id/complete
...
- [x] 6.6 Implement POST /api/admin/coupons/redemptions/:id/reject
...
- [x] 6.7 Implement GET /api/admin/coupons/events/:phone
...
- [x] 7. Integration API Routes





- [x] 7.1 Implement POST /api/integrations/coupons/consume
...
- [x] 7.2 Implement POST /api/integrations/coupons/claim
...
- [x] 7.3 Implement GET /api/integrations/coupons/wallet/:phone
...
- [x] 7.4 Implement POST /api/integrations/coupons/opt-out
...
- [x] 8.1 Implement token cleanup job
...
- [x] 8.3 Implement redemption expiration job
...
- [x] 8.5 Schedule jobs with node-cron
...
- [x] 10. Admin Frontend Components



- [ ] 10. Admin Frontend Components

- [x] 10.1 Create CouponIssuePage component
...
- [x] 10.2 Create CouponRedemptionsPage component
...
- [x] 10.3 Create CouponWalletLookupPage component
...
- [x] 10.4 Add coupon routes to admin navigation
...
- [x] 11. API Hooks for Frontend



- [x] 11.1 Add coupon methods to useAdminApi hook
...
- [x] 12.1 Add N8N_API_KEY to backend .env

  - Generate secure random API key
  - Document in .env.example
  - _Requirements: 16.2, 16.4_

- [x] 12.2 Add WhatsApp number to backend .env

  - Add WHATSAPP_NUMBER variable
  - Use in WhatsApp deep link generation
  - _Requirements: 1.3_

- [x] 12.3 Update backend to use Europe/Istanbul timezone

  - Set TZ environment variable
  - Configure date-fns or moment-timezone
  - _Requirements: 28.1, 28.2_

- [x] 13. n8n Workflow Implementation (Separate from Core Kiosk)





- [x] 13.1 Create n8n workflows directory structure
...
- [x] 13.2 Create Coupon Capture workflow in n8n
...
- [x] 13.3 Create Claim Redemption workflow in n8n
...
- [x] 13.4 Create Balance Check workflow in n8n
...
- [x] 13.5 Create Opt-Out workflow in n8n
...
- [x] 13.6 Configure n8n credentials (template only, no actual secrets)
...
- [x] 13.7 Create n8n deployment scripts
...
- [x] 14. Deployment Configuration (n8n Separate from Kiosk)


- [x] 14.1 Create n8n systemd service file
...
- [x] 14.2 Create nginx/Caddy reverse proxy config
...
- [x] 14.3 Create deployment script for Raspberry Pi
...
- [x] 15. Turkish Localization




- [x] 15.1 Add Turkish message templates to backend i18n
...
- [x] 15.2 Add Turkish message templates to n8n workflows


  - Use i18n templates in WhatsApp send nodes
  - Add staff notification templates
  - _Requirements: 30.1, 30.2, 30.3, 30.4, 30.5_
- [x] 16. Monitoring and Alerting



- [ ] 16. Monitoring and Alerting

- [x] 16.1 Add health check endpoint for coupon system
...
- [x] 16.2 Configure systemd email alerts


  - Set up email notifications for n8n service failures
  - _Requirements: 26.1_

- [x] 16.3 Add logging for rate limit abuse detection


  - Log when rate limit rejections exceed 50/hour
  - _Requirements: 26.5_

- [x] 17. Backup and Restore (Separate n8n and Backend)




- [x] 17.1 Extend existing backend backup script to include coupon tables
...
- [x] 17.2 Create n8n workflow backup script
...
- [x] 17.3 Schedule daily backups (separate schedules)
...
- [x] 18.1 Update README with coupon system overview
...
- [x] 18.2 Create n8n workflow documentation
...
- [x] 18.3 Create admin user guide
