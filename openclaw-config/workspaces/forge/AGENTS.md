...
- Keep the old visible rejection copy for obvious euphemisms like `mutlu son`; conduct escalation should remain a background control until silence triggers.
