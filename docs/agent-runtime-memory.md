...
- That generic massage/spa template should read like a polished front-desk summary, not a raw dump: concise opener, compact section bullets, live price snapshot, spa-access fact, location, contact, and therapist info.
